...
include_once('GoosesoftWoocommerceSuppliers_InstallIndicator.php');

class GoosesoftWoocommerceSuppliers_LifeCycle extends GoosesoftWoocommerceSuppliers_InstallIndicator {
