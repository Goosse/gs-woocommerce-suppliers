...
include_once('GoosesoftWoocommerceSuppliers_OptionsManager.php');

class GoosesoftWoocommerceSuppliers_InstallIndicator extends GoosesoftWoocommerceSuppliers_OptionsManager {
