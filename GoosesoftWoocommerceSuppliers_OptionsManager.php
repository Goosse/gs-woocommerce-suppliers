...
class GoosesoftWoocommerceSuppliers_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'goosesoft-woocommerce-suppliers'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'goosesoft-woocommerce-suppliers'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'goosesoft-woocommerce-suppliers'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'goosesoft-woocommerce-suppliers'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'goosesoft-woocommerce-suppliers');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'goosesoft-woocommerce-suppliers'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'goosesoft-woocommerce-suppliers');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'goosesoft-woocommerce-suppliers'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'goosesoft-woocommerce-suppliers') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'goosesoft-woocommerce-suppliers');
            case 'false':
                return __('false', 'goosesoft-woocommerce-suppliers');

            case 'Administrator':
                return __('Administrator', 'goosesoft-woocommerce-suppliers');
            case 'Editor':
                return __('Editor', 'goosesoft-woocommerce-suppliers');
            case 'Author':
                return __('Author', 'goosesoft-woocommerce-suppliers');
            case 'Contributor':
                return __('Contributor', 'goosesoft-woocommerce-suppliers');
            case 'Subscriber':
                return __('Subscriber', 'goosesoft-woocommerce-suppliers');
            case 'Anyone':
                return __('Anyone', 'goosesoft-woocommerce-suppliers');
        }
        return $optionValue;
    }
